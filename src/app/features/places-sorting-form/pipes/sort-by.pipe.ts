...
export class SortByPipe implements PipeTransform {
  ...
  private sortByPriceLowToHigh(offerFirst: OfferPreview, offerSecond: OfferPreview) {
    return offerFirst.price - offerSecond.price;
  }

  private sortByPriceHighToLow(offerFirst: OfferPreview, offerSecond: OfferPreview) {
    return offerSecond.price - offerFirst.price;
  }

  private sortByTopRatedFirst(offerFirst: OfferPreview, offerSecond: OfferPreview) {
